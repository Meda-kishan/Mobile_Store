		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#storemobilestore-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"storemobilestore-display": {
								"semanticObject": "storemobilestore",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=store.mobilestore",
									"url": sap.ui.require.toUrl("store/mobilestore")
								}
							}
						}
					}
